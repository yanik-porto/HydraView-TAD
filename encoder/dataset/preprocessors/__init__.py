...
def create_preprocessing(config):
    ...
    for step in cfg_preprocessing:
        ...
        elif step == "PreNormalize3D":
            steps.append(PreNormalize3D(**cfg_preprocessing[step]))
        ...
        elif step == "TextFromJson":
            steps.append(TextFromJson(**cfg_preprocessing[step]))
        ...
        elif step == "FuseWindowDimension":
            steps.append(FuseWindowDimension(**cfg_preprocessing[step]))
        elif step == "RetrieveWindowDimension":
            steps.append(RetrieveWindowDimension(**cfg_preprocessing[step]))
        elif step == "DuplicateKeypoints":
            steps.append(DuplicateKeypoints(**cfg_preprocessing[step]))
        elif step == "Duplicate":
            steps.append(Duplicate(**cfg_preprocessing[step]))
        elif step == "TransformConvention":
            steps.append(TransformConvention(**cfg_preprocessing[step]))
        elif step == "SubstituteKeypoint":
            steps.append(SubstituteKeypoint(**cfg_preprocessing[step]))
        elif step == "RandomRot":
            steps.append(RandomRot(**cfg_preprocessing[step]))
        elif step == "RandomRotOneAxis":
            steps.append(RandomRotOneAxis(**cfg_preprocessing[step]))
        else:
