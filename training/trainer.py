...
from tools.evaluation import accuracy, accuracy_reconstruction, accuracy_multiple_labels, tad_accuracy
...
class Trainer:
    ...
    def _run_batch(self, keypoints, labels):
    ...
    def _run_epoch(self, ie):
        ...
        for ib, batch in enumerate(self.dl):
            ...
            loss = self._run_batch(keypoints, labels)
    ...
    def _get_accuracy(self, keypoints, labels, meters=[]):
        feats = self.encoder(keypoints)
    ...
    def _run_eval(self):
        ...
        for batch in self.dl_val:
            ...
            self._get_accuracy(keypoints, labels, metrics)
